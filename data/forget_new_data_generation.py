...
os.makedirs(f"data/forget_new_entities_{N}", exist_ok=True)
with open(f"data/forget_new_entities_{N}/forget.jsonl", "w") as file:
    for entity_name in tqdm(new_entity_names):
...
forget_new_entities = read_jsonl(f"data/forget_new_entities_{N}/forget.jsonl")

text_data = []

for data_point in tqdm(forget_new_entities):
...
with open(f"data/forget_new_entities_{N}/train.jsonl", "w") as file:
