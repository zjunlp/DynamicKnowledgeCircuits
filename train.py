...
from utils import read_jsonl, ModelArguments, DataTrainingArguments


os.environ["WANDB_PROJECT"] = "Circuits"
    ...
    def tokenize_function(data_point):
        ...
        for column in [
            ...
            if data_point.get(column) is not None and data_point.get(column) != "":
                ...
                if (
                    "tinyllama" in model_args.model.lower()
                    and tokenized_attribute["input_ids"][0] == 259
                ):
